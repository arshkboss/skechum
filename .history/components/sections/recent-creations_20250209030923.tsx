  ...
  return (
    <section className="w-full bg-muted/50 py-16">
      <div className="px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <p className="text-center text-muted-foreground mb-12">AI generated images from the past 24 hours</p>
        <div className="relative scroll-pause">
          {/* Fade Overlays - Updated gradients */}
          <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-muted/95 via-muted/50 to-transparent z-10" />
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-muted/95 via-muted/50 to-transparent z-10" />
          
          {/* Auto-scrolling Container */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 h-[500px] overflow-hidden px-2">
            {/* Column 1 */}
