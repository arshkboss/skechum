    ...
    <section className="w-full bg-muted/50 py-16">
      <div className="px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="relative scroll-pause">
          ...
          <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-muted/95  to-transparent z-10" />
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-muted/95  to-transparent z-10" />
