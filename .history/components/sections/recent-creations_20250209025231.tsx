    ...
    <section className="w-full bg-muted/50 py-16">
      <div className="px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="relative scroll-pause">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[500px] overflow-hidden">
            {/* Column 1 */}
            <div className="space-y-4">
              <div className="animate-scroll">
                {[...recentGenerations, ...recentGenerations].map((art, i) => (
                  <div 
                    key={`${art.id}-${i}`} 
                    className="relative aspect-square w-full max-w-[200px] mb-4 transition-transform hover:scale-105"
                  >
                    <img
                      src={art.imageUrl}
                      alt={art.prompt}
