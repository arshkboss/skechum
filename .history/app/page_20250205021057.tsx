  ...
  return (
    <>
      <div className="flex flex-col w-full">
        {/* Hero Section */}
        <section className="px-4 md:px-6 lg:px-8 py-24 space-y-8 max-w-7xl mx-auto w-full">
        ...
        {/* Testimonials */}
        <section className="px-4 md:px-6 lg:px-8 py-24 max-w-7xl mx-auto w-full">
          <div className="text-center space-y-4 mb-12">
        ...
        <section className="w-full bg-muted/50 py-24">
          <div className="px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-xl text-muted-foreground">Pay only for what you need.</p>
            </div>
