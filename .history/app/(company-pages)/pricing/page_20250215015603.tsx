...
const PRODUCT_ID_400_TOKENS = "pdt_euU2AfE7iRo3EFQtAkcBm"
const PRODUCT_ID_800_TOKENS = "pdt_euU2AfE7iRo3EFQtAkcBm"
...
export default function PricingPage() {
  ...
  // Helper function to get product ID based on credits
  const getProductIdByCredits = (credits: number) => {
    switch (credits) {
      case 150:
        return PRODUCT_ID_150_TOKENS
      case 400:
        return PRODUCT_ID_400_TOKENS
      case 800:
        return PRODUCT_ID_800_TOKENS
      default:
        return null
    }
  }
              ...
              >
                <Card className={`relative p-8 h-full flex flex-col backdrop-blur-sm bg-white/50 dark:bg-gray-950/50 ${
                  ...
                  >
                    <Link 
                      href={
                        getProductIdByCredits(plan.credits) 
                          ? getPaymentLink(getProductIdByCredits(plan.credits)!)
                          : `/contact` // Fallback to contact page if no product ID exists
                      }
                    >
                      Get Started
                    </Link>
