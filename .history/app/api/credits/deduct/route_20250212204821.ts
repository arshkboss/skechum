...
import { STYLE_CREDIT_COSTS } from '@/app/(authenticated)/create/types'
...
export async function POST(request: Request) {
  try {
    ...
    const creditsToDeduct = STYLE_CREDIT_COSTS[style]?.credits || STYLE_CREDIT_COSTS['default'].credits
