...
export default function ProfilePage() {
  ...
  // Modify loadImages to preserve existing images more carefully
      ...
      try {
        ...
        if (data) {
          ...
          setImages(prev => {
            ...
            // Prevent duplicate images by checking IDs
  ...
  // Modify the infinite scroll effect to prevent unnecessary loads
  useEffect(() => {
    if (inView && hasMore && !loading && !userLoading) {
      const nextPage = page + 1
      setPage(nextPage)
      loadImages(nextPage)
    }
  }, [inView, hasMore, loading, userLoading, page, loadImages])
    ...
    <div className="container mx-auto p-8">
      ...
      {images.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {/* Move loading indicator outside the grid */}
          {hasMore && (
            <div 
              ref={ref} 
