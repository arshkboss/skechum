...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    if (!prompt || !selectedStyle || !selectedSize) return
    
    try {
      setLoading(true)
      
      // Map your size selection to Recraft sizes
      ...
      const result = await fal.subscribe("fal-ai/recraft-v3", {
        input: {
          prompt,
          image_size: sizeMap[selectedSize] || 'square_hd',
          style: "vector_illustration/line_art", // Using line art style as requested
          colors: []
        },
        logs: true,
